...
class DeviceInfoRepositoryImpl {
  ...
  final SharedPrefsRepositoryImpl _sharedPrefs =
      SharedPrefsRepositoryImpl.instance;
  final NetworkRepositoryImpl _networkRepo = NetworkRepositoryImpl.instance;
  ...
  Future<DeviceInfoModel> getAndroidInfo() async {
    ...
    final localIp = await _networkRepo.getLocalIPAddress();
